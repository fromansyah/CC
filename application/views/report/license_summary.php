<?php 
    $filename = 'license_summary_'.date("Y_m_d").'.xls';
...
<html>
    ...
    <body>
        <table>
            <tr>
                <th colspan="13">License Summary</th>
            </tr>
            <tr>
                <th colspan="13">Period : <? $from_date = DateTime::createFromFormat('Y-m-d', $from)->format('d F Y');
