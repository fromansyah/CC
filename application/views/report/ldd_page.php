<!DOCTYPE html>    
	...
	<body>
	    <div class="container">
			<h4 style="color: #808080;">License Due Date Report</h4>
			<form action="<?=base_url()?>index.php/Report/ajax_run_license_due_date_new" class="form-horizontal" method="post" class="form-horizontal" enctype="multipart/form-data" id="form_license_due_date">
