<div class="container">
        <span width="100" style="background-color: #e0e0e0; display: block;">
            &nbsp;<font size="5" style="font-weight: bold; color: #737373">User Management</font>
        </span>
        <br/>
...
function view_country(user_id) {
  window.location = _base_url + 'User_country/lists/' + user_id;
}
</script>
