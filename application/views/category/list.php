<div class="container">
        <span width="100" style="background-color: #e0e0e0; display: block;">
            &nbsp;<font size="5" style="font-weight: bold; color: #737373">Application Management</font>
        </span>
        <br/>
        <button class="btn btn-success" onclick="add_category()"><i class="glyphicon glyphicon-plus"></i> Add Program</button>
...
function add_category()
{
    ...
    $('.modal-title').text('Add Application'); // Set Title to Bootstrap modal title
}
